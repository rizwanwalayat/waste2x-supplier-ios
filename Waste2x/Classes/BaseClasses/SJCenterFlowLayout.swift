...
//    //TAK : The collection view wasnt getting direction changed in arabic format, which was creating UI and data handling issues
//    override var flipsHorizontallyInOppositeLayoutDirection: Bool{
//        return Constants.isArabicLangageSelected()
//    }
